...
export async function getFileById(id: number): Promise<FileDetail | null> {
	try {
		...
		return {
			...
			doc2: selectedFile.doc2,
			doc3: selectedFile.doc3,
			doc4: selectedFile.doc4,
			doc5: selectedFile.doc5,
			doc6: selectedFile.doc6,
			...
			note_plain_text: selectedFile.note_plain_text, // Prisma String? is string | null, FileDetail expects string | null
		};
	} catch (error) {
