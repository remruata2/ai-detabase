-- Prisma-compatible PostgreSQL import for MySQL sample data
...
INSERT INTO "file_list" (
    ...
    'Arms, Smuggling etc.', 
    'ARMS RECOVERED',
    '<p><span style="font-size:12pt"><strong><span style="font-size:16.0pt"><span style="color:black">II. ARMS RECOVERED:</span></span></strong></span></p>',
    '', '', '', '', '', '', 
    '31/05/2007', 
    '2007-05-31',
...
INSERT INTO "file_list" (
    ...
    '<p style="text-align:center"><span style="font-size:12pt"><strong>CID(SB) ACHIEVEMENTS DURING 2009 AS ON 30.7.09.</strong></span></p>',
    '', '', '', '', '', '',
    '30/07/2009',
    '2009-07-30', 
...
INSERT INTO "file_list" (
    ...
    '<p style="text-align:center"><span style="font-size:12pt"><strong><span style="font-size:16.0pt">OFFICE OF THE SUPERINTENDENT OF POLICE</span></strong></span></p>',
    '', '', '', '', '', '',
    '01/01/2009',
    '2009-01-01',
