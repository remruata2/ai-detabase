 ...
 * 
 * Usage:
 * node scripts/import-data.js <path-to-sql-file> [--clear]
 * 
 * Example:
 * node scripts/import-data.js ./sample_data.sql
 * node scripts/import-data.js ./sample_data.sql --clear
 */
...
async function main() {
  try {
    ...
    if (!sqlFilePath) {
      ...
      console.error('Usage: node scripts/import-data.js <path-to-sql-file> [--clear]');
      process.exit(1);
    }
    ...
    if (shouldClearExisting) {
      ...
      await prisma.fileList.deleteMany({});
